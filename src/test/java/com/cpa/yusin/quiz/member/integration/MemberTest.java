                                ...
                                .andDo(document("회원가입 - 이메일 형식 오류",
                                                ...
                                                responseFields(
                                                                ...
                                                                fieldWithPath("message").type(JsonFieldType.STRING)
                                                                                .description("메세지"),
                                                                fieldWithPath("valueErrors[].descriptor")
                                                                                .type(JsonFieldType.STRING)
                                                                                .description("오류 항목"),
                                                                fieldWithPath("valueErrors[].rejectedValue")
                                                                                .type(JsonFieldType.STRING)
                                                                                .description("오류 내용"),
                                                                fieldWithPath("valueErrors[].reason")
                                                                                .type(JsonFieldType.STRING)
                                                                                .description("오류 원인"))));
        }
                ...
                resultActions
                                ...
                                .andDo(document("회원 수정 - 성공",
                                                ...
                                                responseFields(
                                                                ...
                                                                fieldWithPath("data.role").type(JsonFieldType.STRING)
                                                                                .description("유저 권한"),
                                                                fieldWithPath("data.subscriberExpiredAt")
                                                                                .type(JsonFieldType.STRING)
                                                                                .description("구독 만료일").optional(),
                                ...
                                .andDo(document("회원 전체 조회",
                                                ...
                                                responseFields(
                                                                ...
                                                                fieldWithPath("pageInfo.totalElements")
                                                                                ...
                                                                                .description("총 데이터 수").optional(),
                                                                fieldWithPath("pageInfo.totalPages")
                                                                                .type(JsonFieldType.NUMBER)
                                                                                .description("총 페이지 수").optional(),
                                                                fieldWithPath("pageInfo.currentPage")
                                                                                .type(JsonFieldType.NUMBER)
                                                                                .description("현재 페이지").optional(),
