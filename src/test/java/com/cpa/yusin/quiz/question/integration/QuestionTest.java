...
class QuestionTest {
                                ...
                                .andDo(document("updateQuestion",
                                                ...
                                                responseFields(
                                                                ...
                                                                fieldWithPath("data.content").type(JsonFieldType.STRING)
                                                                                .description("질문 내용"),
                                                                fieldWithPath("data.answerCount")
                                                                                .type(JsonFieldType.NUMBER)
                                                                                .description("질문의 답변 수"),
                                                                fieldWithPath("data.answeredByAdmin")
                                                                                .type(JsonFieldType.BOOLEAN)
                                                                                .description("질문 답변 여부"),
        ...
        void getAllByProblemId() throws Exception {
                // given
                questionRepository.save(Question.builder().id(2L).title("2번은 왜 정답이 아니죠?").answerCount(0)
                                .content("2번은 왜 정답이 아니죠?").member(member).problem(problem).build());
                questionRepository.save(Question.builder().id(3L).title("3번은 왜 정답이 아니죠?").answerCount(0)
                                .content("3번은 왜 정답이 아니죠?").member(member).problem(problem).build());
                questionRepository.save(Question.builder().id(4L).title("4번은 왜 정답이 아니죠?").answerCount(0)
                                .content("4번은 왜 정답이 아니죠?").member(member).problem(problem).build());
                questionRepository.save(Question.builder().id(5L).title("5번은 왜 정답이 아니죠?").answerCount(0)
                                .content("5번은 왜 정답이 아니죠?").member(member).problem(problem).build());
                questionRepository.save(Question.builder().id(6L).title("6번은 왜 정답이 아니죠?").answerCount(0)
                                .content("6번은 왜 정답이 아니죠?").member(member).problem(problem).build());
                questionRepository.save(Question.builder().id(7L).title("7번은 왜 정답이 아니죠?").answerCount(0)
                                .content("7번은 왜 정답이 아니죠?").member(member).problem(problem).build());
                questionRepository.save(Question.builder().id(8L).title("8번은 왜 정답이 아니죠?").answerCount(0)
                                .content("8번은 왜 정답이 아니죠?").member(member).problem(problem).build());
        ...
        void deleteById() throws Exception {
                ...
                // when
                ResultActions resultActions = mvc
                                .perform(delete("/api/v1/question/{questionId}", questionId)
                                                .with(user(memberDetails)));
